...
export async function createMovie(title:string, synopsis:string, releaseYear: string, duration: string, genres:Array<number>) {
    try {
        const response = await movie.createMovieModel(title, synopsis, releaseYear, duration, genres);
        return response;
    }
    catch(err){
